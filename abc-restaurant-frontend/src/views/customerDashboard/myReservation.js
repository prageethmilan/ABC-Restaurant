...
import {
  getAllReservationFromTableType, getAllReservationsByUserId, getReservationQueriesById, saveQueryForReservation
...
const MyReservation = () => {
  ...
  const fetchAllReservations = (id) => {
    getAllReservationsByUserId(id).then(response => {
